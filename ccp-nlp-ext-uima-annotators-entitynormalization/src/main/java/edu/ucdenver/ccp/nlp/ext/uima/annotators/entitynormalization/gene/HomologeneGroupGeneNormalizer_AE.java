 ...
 * 
 */
public class HomologeneGroupGeneNormalizer_AE extends JCasAnnotator_ImplBase {
	...
	public static final String PARAM_HOMOLOGENE_DICTIONARY_DIRECTORY = ConfigurationParameterFactory
			.createConfigurationParameterName(HomologeneGroupGeneNormalizer_AE.class, "dictionaryDirectory");
	...
	public static final String PARAM_DOCUMENT_METADATA_EXTRACTOR_CLASS = ConfigurationParameterFactory
			.createConfigurationParameterName(HomologeneGroupGeneNormalizer_AE.class,
	...
	public void initialize(UimaContext context) throws ResourceInitializationException {
		...
		dictionary = new BerkeleyDbDictionary<BerkeleyDbGeneNameEntry>(dictionaryDirectory,
				HomologeneDictionaryBuilder.STORE_NAME, HomologeneDictionaryBuilder.ENTRY_INDEX_ACCESSOR_CLASS,
				HomologeneDictionaryBuilder.DICTIONARY_ENTRY_CLASS);
		dictionary.open(AccessMode.READONLY);

		try {
			geneNameRegularizer = HomologeneDictionaryBuilder.ENTRY_REGULARIZER_CLASS.newInstance();
	...
	public static AnalysisEngineDescription createAnalysisEngineDescription(TypeSystemDescription tsd,
			...
			throws ResourceInitializationException {
		return AnalysisEngineFactory.createPrimitiveDescription(HomologeneGroupGeneNormalizer_AE.class, tsd,
