 ...
 * 
 */
public class HomologeneGroupGeneNormalization_AAE {

	public static AnalysisEngineDescription getAggregateDescription(TypeSystemDescription tsd,
			File homologeneDictionaryDirectory) throws ResourceInitializationException {
		...
		AnalysisEngineDescription homologeneGroupNormalizer = HomologeneGroupGeneNormalizer_AE
