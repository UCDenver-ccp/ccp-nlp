...
public abstract class UriFactory {
	...
	public static final URI KIAO_MENTIONS_PATHWAY = new URIImpl(RdfUtil.createUri(RdfNamespace.KIAO, "mentionsPathway")
			.toString());
	public static final URI IAO_MENTIONS = new URIImpl(RdfUtil.createUri(RdfNamespace.IAO, "mentions").toString());
	public static final URI KIAO_MENTIONS_EVENT = new URIImpl(RdfUtil.createUri(RdfNamespace.KIAO, "mentionsEvent")
			.toString());
	...
	// uris.add(new URIImpl(RdfUtil.createIaoUri(RdfNamespace.KABOB,
	// RdfUtil.getNamespace(id.getDataSource()),
