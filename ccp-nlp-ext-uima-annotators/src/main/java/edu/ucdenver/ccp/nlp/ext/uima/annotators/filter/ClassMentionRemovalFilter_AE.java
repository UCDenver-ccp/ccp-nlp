...
/**
 * This utility analysis engine enables the user to remove all annotations that are not a specific class mention type from the CAS indexes.
 * 
...
public class ClassMentionRemovalFilter_AE extends JCasAnnotator_ImplBase {
    ...
    /**
     * cycle through all annotations and remove those that have annotation types in the class-mention-types-to-remove list
     */
    public void process(JCas jcas)  {
        ...
        logger.info("ClassMentionRemovalFilter Removed " + count + " annotations.");

    }
    
	public static AnalysisEngine createAnalysisEngine(TypeSystemDescription tsd, 
			String[] removeMentions) 
