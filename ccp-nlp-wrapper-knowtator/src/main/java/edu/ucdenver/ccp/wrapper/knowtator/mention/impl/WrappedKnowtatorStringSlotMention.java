...
public class WrappedKnowtatorStringSlotMention extends StringSlotMention {
	private SimpleInstance knowtatorSM;
	private KnowtatorUtil ku;
	
	public WrappedKnowtatorStringSlotMention(SimpleInstance knowtatorMention, KnowtatorUtil ku) {
...
//			if (possibleSM.getDirectType().getName().equals(ku.getSlotMentionCls().getName())) {
				if (ku.isStringSlotMention(possibleSM)) {
					this.knowtatorSM = possibleSM;
					return;
				}
//			}
		}
		throw new KnowledgeRepresentationWrapperException("Expected Knowtator string slot mention. Cannot wrap a "
...
//	}
	...
	public void addSlotValues(Collection<String> slotValues)
	...
	public void overwriteSlotValues(String slotValue)
			throws InvalidInputException {
		Collection<String> newSlotValues = new ArrayList<String>();
		newSlotValues.add(slotValue);
		setSlotValues(newSlotValues);
	}

	public void setSlotValues(Collection<String> slotValues)
			throws InvalidInputException {
